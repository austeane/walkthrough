...
**Prime directive**: The walkthrough exists to help the developer understand their own codebase — the what and the why. It is NOT a 1:1 transcript replay. If an agent did 100 distinct things across 5 sessions, the walkthrough might be 5-10 steps, not 100 slides. The agent must compress, group, and editorialize. Brevity and focus outrank completeness: the right question is "what does this reader need for this purpose?" not "what happened chronologically?"
